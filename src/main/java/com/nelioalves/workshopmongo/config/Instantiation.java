...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom diaa", "Acordei muito feliz!", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa viajem mano!", sdf.parse("31/03/2018"), new AuthorDTO(alex));
